...
private:
    ...
    bool checkValidationLayerSupport() {
        ...
        // Show validation layer's names.
        std::cout << "Available layers:" << std::endl;
        for (const auto &layer : availableLayers) {
            std::cout << "\t" << layer.layerName << std::endl;
        }
        std::cout << "Requred layers:" << std::endl;
    ...
    void pickPhysicalDevice() {
        ...
        if (deviceCount == 0) {
            throw std::runtime_error("Failed to find GPUs with Valkan support.");
        }
...
//        {
//            std::cout << "Device does not support Geometry Shader." << std::endl;
//            return 0;
//        }
